# 🎮 Petra's Game — Witches & Princesses
## By Petra (age 6), Game Designer 👑
...
| | |
|---|---|
| **🏷️ Game Name** | Petra's Game — Witches & Princesses |
| **🦸 Hero** | The Brave Princess — flowing hair, ornate crown with gem, magic wand with spinning star, sparkle aura, rosy cheeks, blue eyes ✨ |
| **😈 Villain** | The Wicked Witch — tall bent hat with stars, golden buckle, magic orb with swirling energy, slit cat-eyes, wicked grin, flowing cape, green smoke wisps 🧙 |
| **🌍 World** | Three connected worlds: the Witch's dark Labyrinth 🕷️, the Princess Castle 👑 (with throne, pillars, candle flames, and 3 princess NPCs), and the Real World 🏠 (cozy cottage with chimney smoke, garden with flowers, sunshine) |
| **🎯 Goal** | The princess must navigate the labyrinth, survive the castle's spell, and reach home — the Real World! |
| **🕹️ Main Action** | Move through the maze, avoid spider webs, use magic blast to destroy webs, fight the castle's freezing spell |
...
```
┌─────────────────────────────────────────────┐
│     ⭐ REAL WORLD ⭐  (cottage, flowers)     │
│            🚪 Golden Door                    │
│     👑 PRINCESS CASTLE 👑                    │
│     (throne, pillars, candles, NPCs)         │
│            🚪 Pink Door                      │
│     🕷️ WITCH LABYRINTH 🕷️                   │
│     (procedural maze, dark purple walls)     │
│     🧙 Witch starts here   👑 Princess here  │
└─────────────────────────────────────────────┘
```
...
**👑 Player 1 — The Brave Princess**
- ↑ ↓ ← → to move
- SHIFT for ✨ Magic Blast (3 uses — destroys webs!)

**🧙 Player 2 — The Wicked Witch**
- W A S D to move
- E for 🕸️ Spider web (slows princess)
- Q for ☠ Super web (bright green — traps 4 seconds!)

**⏱️ Timer: 120 seconds!**

---

### 📝 Petra's Feedback History

**Version 2 feedback:**
- "The princess needs superpowers!" → Added magic blast
